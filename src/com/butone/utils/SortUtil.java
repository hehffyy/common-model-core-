...
public class SortUtil {
	...
	public static class ShellSort implements SortUtil.Sort {
		 ...
		 * @param i
		 */
		private void insertSort(Object[] data, CompareCallBack c, int start,
				int inc) {
	...
	public static class QuickSort implements SortUtil.Sort {
		...
		private int partition(Object[] data, CompareCallBack c, int l, int r,
				Object pivot) {
			do {
	...
	public static class MergeSort implements SortUtil.Sort {
		...
		private void mergeSort(Object[] data, CompareCallBack c, Object[] temp,
				int l, int r) {
			int mid = (l + r) / 2;
			if (l == r)
				return;
